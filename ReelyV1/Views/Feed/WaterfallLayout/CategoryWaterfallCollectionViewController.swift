//
//  CategoryWaterfallCollectionViewController.swift
//  FITs
//
...
struct CategoryWaterfallCollectionViewController: UIViewControllerRepresentable {
    ...
    func updateUIViewController(_ uiViewController: UICollectionViewController, context: Context) {
        ...
        //TODO: Scale out the scroll to tops
...
//        }
    ...
    func makeCoordinator() -> Coordinator {
        Coordinator(self, uiCollectionViewController: uiCollectionViewController, postDetailViewModel: $selectedPostDetail, selectedCategoryTag: $selectedCategoryTag)
    }

    class Coordinator: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout {
        var parent: CategoryWaterfallCollectionViewController
        var uiCollectionViewController: UICollectionViewController
        var screenWidth = 0.0
        var cardWidth = 0.0
        ...
        init(_ parent: CategoryWaterfallCollectionViewController, uiCollectionViewController: UICollectionViewController, postDetailViewModel: Binding<PostDetailViewModel>, selectedCategoryTag: Binding<String>) {
            self.parent = parent
        ...
        func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
            if let post = parent.homeViewModel.getPostModelsWithCategoryTag(tag: selectedCategoryTag)?[indexPath.item] {
        ...
        func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            parent.homeViewModel.getPostModelsWithCategoryTag(tag: selectedCategoryTag)?.count ?? 0
        }
