//
//  BoardWaterfallCollectionView.swift
//  FITs
//
...
struct BoardWaterfallCollectionView: UIViewControllerRepresentable {
    ...
    func makeUIViewController(context: Context) -> UICollectionViewController {
        ...
        let uiAction = UIAction(handler: { uiAction in
            ...
            let propertiesDict = ["feed": "Board"] as? [String : String]
    ...
    func updateUIViewController(_ uiViewController: UICollectionViewController, context: Context) {
        ...
        if (bookmarkBoardViewModel.shouldScrollToTop && bookmarkBoardViewModel.postsData.postModels?.count ?? 0 > 0) {
            uiViewController.collectionView.scrollToItem(at: IndexPath(row: 0, section: 0),
                                              at: .top,
                                        animated: true)
            bookmarkBoardViewModel.shouldScrollToTop = false
        }
    }
    ...
    class Coordinator: NSObject, UICollectionViewDelegate, UICollectionViewDataSource, CHTCollectionViewDelegateWaterfallLayout {
        var parent: BoardWaterfallCollectionView
        var uiCollectionViewController: UICollectionViewController
        var screenWidth = 0.0
        var cardWidth = 0.0
        @Binding var postDetailViewModel: PostDetailViewModel
        
        init(_ parent: BoardWaterfallCollectionView, uiCollectionViewController: UICollectionViewController, postDetailViewModel: Binding<PostDetailViewModel>) {
            self.parent = parent
        ...
        func collectionView(_ collectionView: UICollectionView, layout collectionViewLayout: UICollectionViewLayout, sizeForItemAt indexPath: IndexPath) -> CGSize {
            if let post = parent.bookmarkBoardViewModel.postsData.postModels?[indexPath.item] {
        ...
        func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
            parent.bookmarkBoardViewModel.postsData.postModels?.count ?? 0
        }
...
//                }
        ...
        func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath) {
            if let post = parent.bookmarkBoardViewModel.postsData.postModels?[indexPath.item] {
                ...
                parent.bookmarkBoardViewModel.shouldPopToRootViewIfFalse = true
            }
        }
    }
}
