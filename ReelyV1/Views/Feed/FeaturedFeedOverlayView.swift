        ...
        ZStack {
            ...
            VStack {
                ...
                Text("Featured Posts")
                    ...
                    .padding(.vertical, 4)
                    .padding(.horizontal, 24)
                Text("Every Sunday, the 10 most informative posts of the week will be featured to the community.")
                    .font(Font.custom(Constants.bodyFont, size: 18))
                    .foregroundColor(Color.black)
                    .multilineTextAlignment(.center)
                    .padding(.horizontal, 24)
                    .padding(.bottom, 8)
                KFImage(URL(string: Constants.featuredPostImageUrl))
                    .resizable()
                    .scaledToFit()
                    .cornerRadius(Constants.buttonCornerRadius)
                    .padding(.horizontal, 24)
                    .padding(.vertical, 8)
                Text("The more details you share about the outfit and products, the more you'll help inspire the community's fashion choices!")
