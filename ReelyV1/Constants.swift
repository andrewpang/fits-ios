...
struct Constants {
    ...
    static let largeTextSize: CGFloat = 32
    ...
    static let profilePageProfilePicSize: CGFloat = 100
    ...
    static let featuredPostImageUrl = "https://firebasestorage.googleapis.com/v0/b/reelyv1.appspot.com/o/appImages%2Ffabulous-clothing-atelier-1.png?alt=media&token=8fe3f6aa-08ce-43cb-beba-6899f563e6af"
}
